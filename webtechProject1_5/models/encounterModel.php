...
function updateEncounter($data){
    ...
    $sql = "UPDATE Encounter SET PatientID='$PatientID', DoctorID='$DoctorID', Vitals='$Vitals', DiagnosisICD='$DiagnosisICD', Attachments='$Attachments' WHERE EncounterID=$id";
    return mysqli_query($con, $sql);
}
