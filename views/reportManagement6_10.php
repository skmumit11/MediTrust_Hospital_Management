        ...
        <div class="container card">
            <div class="header-flex">
                ...
                <div class="header-actions">
                    <a href="../controllers/labReportController6_10.php?action=download" class="btn btn-outline">Download
                        CSV</a>
                    <a href="../controllers/labReportController6_10.php?action=print" class="btn btn-outline">Print
                        List</a>
                </div>
            </div>

            <form action="../controllers/labReportController6_10.php?action=view" method="get" class="filter-form">
                <div class="form-row">
                            ...
                            <?php foreach ($rows as $r) { ?>
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a href="downloadSingleResult6_10.php?result_id=<?php echo htmlspecialchars($r['ResultID']); ?>"
                                            class="link-action">
                                            Open / Print
                                        </a>
                                    </td>
