    ...
    <div class="main-content">
        <div class="container">
            ...
            <div class="card">
                ...
                <form action="../controllers/insuranceCreate.php" method="post">
                    ...
                    <div class="form-actions">
                        ...
                        <a href="admindashboard_6_10.php" class="btn btn-secondary">Cancel</a>
                    </div>
                </form>
            </div>
                            ...
                            <?php } else { ?>
                                <?php foreach ($records as $r) { ?>
                                    <tr>
                                        ...
                                        <td>
                                            <a href="insurance_edit.php?id=<?php echo $r['InsuranceID']; ?>" class="link-action"
                                                style="color: var(--accent); margin-right: 10px;">Edit</a>
                                            <a href="../controllers/insuranceDelete.php?id=<?php echo $r['InsuranceID']; ?>"
