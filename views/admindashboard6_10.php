  ...
  <div class="main-content" style="margin-top: 80px;">
    ...
    <div class="container-fluid">
      ...
      <div class="actions-grid">
        <a href="billing/generateBill6_10.php" class="action-btn">
          <i class="fas fa-file-invoice-dollar"></i>
          <span>New Invoice</span>
        </a>

        <a href="lab/testResultEntry6_10.php" class="action-btn">
          <i class="fas fa-vial"></i>
          <span>Lab Entry</span>
        </a>

        <a href="insurance_create6_10.php" class="action-btn">
          <i class="fas fa-file-medical"></i>
          <span>Insurance</span>
        </a>

        <a href="staff_add6_10.php" class="action-btn">
